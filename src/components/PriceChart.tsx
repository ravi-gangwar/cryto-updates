...
export const PriceChart: React.FC<PriceChartProps> = ({ data, coinName, loading }) => {
  if (loading) {
    return (
  ...
  if (!data) {
    return (
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
        <h3 className="text-xl font-bold text-gray-800 dark:text-white mb-4">Price Chart - Last 7 Days</h3>
  ...
  const isPositiveTrend = chartData[chartData.length - 1].price > chartData[0].price;
